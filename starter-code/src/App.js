    ...
    <div className="Container">
      <article class="message is-success">
        ...
        <div className="message">
          {props.message} <strong className="strong">{props.strong}</strong>
        </div>
      </article>
    </div>
  );
  ...
  return (
    <div>
      ...
      <CoolButton
        ...
        text="Log out"
      ></CoolButton>
      <Message message="This is the message" strong="This is another message" />
    </div>
  );
};

export default App;
export { FormField, CoolButton };
